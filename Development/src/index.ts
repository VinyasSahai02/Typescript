...
class subUser extends User{
    ...
    changeCourseCount(){
        this.course_Count=7; //protected keyword makes course_count accessible
        //protected makes the property accessible in inherited classes
        //subuser extends user class--> inheritence
    }
}
